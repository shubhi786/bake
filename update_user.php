...
<head>
    ...
    <!-- sweet alert -->
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/sweetalert2@11.0.17/dist/sweetalert2.css">
...
<nav>
    ...
    <section class="signup_form">
        ...
        <h1 class="text-center text-capitalize">edit profile</h1>
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                $sql = "UPDATE users SET `fname`='$fname',`uname`='$uname',`pass`='$pass',`mobile`='$mobile',`address`='$address',`email`='$email' WHERE `uname`='$get_name' ";
                $run = $conn->query($sql);
            ...
            $get = "SELECT * FROM users WHERE uname='$get_name' LIMIT 1";
            $val = $conn->query($get);
            ...
            <div class="parent">
                <input type="text" name="uname" id="uname" placeholder="" value="<?php echo $row['uname'];?>">
