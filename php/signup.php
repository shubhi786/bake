...
<nav>
    ...
    <section class="signup_form">
        ...
        <?php
            ...
            if(isset($_POST['submit']))
            {
                ...
                if(in_array($check,$arr))
                {
                    ...
                    $sql = "INSERT INTO users VALUES('0','$fname','$uname','$pass','$mobile','$address','$email','$folder',now())";
                    $run = $conn->query($sql);
        ...
        ?>
            ...
            <span><p class="text-center mt-3">Are you existing user... <a href="login.php" class="">Login here</a> </p></span>
